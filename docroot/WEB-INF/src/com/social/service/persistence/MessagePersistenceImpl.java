...
import com.social.NoSuchMessageException;

import com.social.model.Message;
import com.social.model.impl.MessageImpl;
import com.social.model.impl.MessageModelImpl;
...
public class MessagePersistenceImpl extends BasePersistenceImpl<Message>
	...
	@Override
	public Message updateImpl(com.social.model.Message message)
	...
	protected Message toUnwrappedModel(Message message) {
		...
		messageImpl.setTitle(message.getTitle());
		messageImpl.setContent(message.getContent());
		messageImpl.setDate(message.getDate());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.social.model.Message")));
